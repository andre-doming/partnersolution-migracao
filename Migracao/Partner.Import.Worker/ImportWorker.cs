...
using ImportQueries = Partner.Api.Features.Import.ImportQueries;
using ImportSelectedLineRequest = Partner.Api.Features.Import.ImportSelectedLineRequest;
...
namespace Partner.Import.Worker;
